    ...
    <div className="home">
      <header className="header">
        <nav className="nav">
          ...
          <a href="#waitlist" className="download-button">Join Waitlist</a>
        </nav>
      </header>
      ...
      <main>
        ...
        <section className="hero">
          <div className="hero-container">
            ...
            >
              ...
              >
                <span className="gradient-text">Stop Wasting Food.</span><br />
                Start Saving Money.
              </motion.h1>
              <motion.p 
              ...
              >
                Too busy to track groceries? Santry is your intelligent kitchen assistant 
                that automatically manages your inventory, suggests recipes based on what you love, 
                and ensures nothing goes to waste.
              </motion.p>
              <motion.a 
                href="#waitlist" 
                className="hero-cta"
            ...
            >
              ...
              >
                <img src={appMockup} alt="Santry App" className="app-mockup-image" />
              </motion.div>
            </motion.div>
          </div>
        </section>
        ...
        >
          <div className="section-container">
            ...
            <motion.p 
              ...
              transition={{ duration: 0.6, delay: 0.2 }}
            >
              You're busy. Between work, family, and life, who has time to manage a kitchen? 
              But without tracking what you have, perfectly good food—and your hard-earned money—goes straight to the trash.
            </motion.p>
            ...
            <div className="problem-stats-grid">
              ...
              >
                ...
                <div className="stat-description">Average household food waste per year</div>
              </motion.div>
              ...
              <div className="problem-facts">
                ...
                >
                  ...
                  <div className="fact-text">of food wasted annually in the US alone</div>
                </motion.div>
                <motion.div 
                  className="problem-fact-item"
                  initial={{ opacity: 0, x: 20 }}
                ...
                >
                  ...
                  <div className="fact-text">of all food produced goes to waste</div>
                </motion.div>
                <motion.div 
                  className="problem-fact-item"
                  initial={{ opacity: 0, x: 20 }}
                ...
                >
                  ...
                  <div className="fact-text">total economic cost of food waste in the US</div>
                </motion.div>
              </div>
            </div>
            ...
            >
              <p>
                <strong>You don't have time for complex systems.</strong> That's why Santry does the heavy lifting. 
                Snap a photo, speak what you bought, or let AI identify it—then relax while Santry tracks everything, 
                reminds you before food expires, and suggests delicious recipes you'll actually want to make.
              </p>
            </motion.div>
          </div>
        </motion.section>
        ...
        >
          <div className="section-container">
            ...
            >
              No time for manual entry? Choose the method that fits your lifestyle—takes seconds, not minutes
            </motion.p>
              ...
              {[
                {
                  ...
                  description: "Just finished shopping? Snap your receipt. Our AI reads it and adds everything instantly. Done in 5 seconds.",
                  inDevelopment: false
                },
                {
                  visual: "voice-visual",
                  title: "Voice Input",
                  description: "Hands full? Just say what you bought while unpacking. AI transcription handles the rest—completely hands-free.",
                  inDevelopment: false
                },
                {
                  visual: "ai-visual",
                  title: "Photo Recognition",
                  description: "Snap a quick photo of your groceries. Our AI identifies and catalogs everything automatically. No typing required.",
                  inDevelopment: true
                }
              ].map((method, index) => (
                <motion.div
        ...
        >
          <div className="section-container">
            <motion.h2 
              ...
              transition={{ duration: 0.6 }}
            >
              Kitchen Intelligence That Works For <span className="gradient-text">You</span>
            </motion.h2>
            ...
            <div className="mission-content">
              <div className="mission-text">
                ...
                <motion.p 
                  ...
                  transition={{ duration: 0.6, delay: 0.1 }}
                >
                  You're juggling a lot. Work deadlines, family obligations, a social life you're 
                  trying to maintain. Who has time to be a kitchen manager too?
                </motion.p>
                <motion.p 
                  className="mission-description"
                  initial={{ opacity: 0, x: -20 }}
                  ...
                  transition={{ duration: 0.6, delay: 0.2 }}
                >
                  <strong>That's where Santry comes in.</strong> Think of us as the household help 
                  you wish you had—tracking your food, planning meals around your preferences, 
                  reminding you before things expire, and making sure you eat well without the mental load.
                </motion.p>
                <motion.p 
                  className="mission-description"
                  initial={{ opacity: 0, x: -20 }}
                  ...
                  transition={{ duration: 0.6, delay: 0.3 }}
                >
                  We're here to give busy people back their time and peace of mind. Less waste, 
                  better nutrition, zero stress—all happening quietly in the background while you live your life.
                </motion.p>
              </div>
              <motion.div 
        ...
        >
          <div className="section-container">
            ...
            <motion.p 
              ...
              transition={{ duration: 0.6, delay: 0.1 }}
            >
              Join the waitlist and be first to experience effortless kitchen management when Santry launches on iOS.
            </motion.p>
            ...
            <motion.p 
              ...
              transition={{ duration: 0.6, delay: 0.3 }}
            >
              Launching first on iOS • Early 2025
            </motion.p>
          </div>
        </motion.section>
      </main>
      ...
      <footer className="footer">
        <div className="footer-content">
          ...
          <div className="footer-text">
            <p>&copy; 2025 Santry. Reducing food waste, one household at a time.</p>
          </div>
        </div>
      </footer>
    </div>
